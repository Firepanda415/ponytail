...
const INVARIANTS = [
  ...
  'Use the existing test system',          // reuse coverage instead of a fixed test quota
  'peak memory',                          // source length must not override resource constraints
  ...
  'security',
  'accessibility',
  'scientific',                            // preserve scientific meaning under simplification
];
