...
const DESCRIPTIONS = {
  'ponytail': 'Simple coding changes within correctness and resource constraints. Reuse optimized kernels and verify changed failure modes. Not for non-coding requests.',
  'ponytail-review': 'Review a diff for justified simplifications that preserve behavior, scientific meaning, and resource constraints.',
  ...
  'ponytail-gain': 'Show historical upstream benchmark results and their scope. They do not validate this customized fork or predict current-repository savings.',
